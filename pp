{
  "sites": [
    ...
    },
    {
      ...
      "name": "百度云资源",
      "type": 1,
      "api": "http://api.dbyunzy.com/api.php/provide/vod/?ac=list"
    },
    {
      "key": "安逸影院",
      "name": "安逸影院",
    ...
    },
    {
      ...
      "name": "老鸭福利",
      "type": 0,
      "api": "1https://api.apilyzy.com/api.php/provide/vod/at/xml"
    },
    {
      "key": "芒果福利",
      "name": "芒果福利",
  ...
  "spider": "https://gitee.com/CCSHCoder/tv/blob/master/custom_spider.jar",
  "parses": [
    {
      "name": "Json并发",
      "type": 2,
    ...
    },
    {
      ...
      "channels": [
        ...
        },
        {
          "name": "死神来了轮播",
          "urls": [
            "http://107.148.254.201:13164/v/huya.php?id=11352903"
          ]
        },
        {
          "name": "成龙经典",
